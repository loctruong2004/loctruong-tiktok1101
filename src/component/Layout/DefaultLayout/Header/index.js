...
function Header() {
    const [selectProfile, setSelect] = useState(false);
    
      return <header className={cx('wrapper')}>
            <Link to={routeConfig.Home} className={cx('logo-header')}>
                  <svg width="118" height="42" fill="currentColor" alt="TikTok">
           ...
           <Search/>
            <div className={cx('option-header')}>
                  ...
                  <div className={cx('wrap-icon')}>
                        ...
                        <Tippy
                              render={attrs => (
                                    <div className={cx('hover-message')} tabIndex="-1" {...attrs}>
                                          <div className={cx('wrap-arow')}>
                                          <div className={cx('arow')}></div>
                                          </div>
                        ...
                        <Menu>
                              <div className={cx('image')} onClick={()=>{setSelect(true)}} onBlur={()=>{setSelect(false)}}>
                              <Profile 
                               src="https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-6/341685208_909099900310664_8122487275387452779_n.jpg?_nc_cat=1&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=yXdPWg3nwn0AX8VA1Ps&_nc_oc=AQnvaaYYBx3pbYJ5g08ImQs22fIz03JtafL6U9eQtTvkR6Isyuy81LmbCDwQH4j5mwQ&_nc_ht=scontent.fhan18-1.fna&oh=00_AfDwd-iLb8AtJqOTsYD9yqzyHhT6lx6JS5RiUrDwJmXCGw&oe=64C5BBC4"
                               alt="chelsea"
                              />
                              </div>
                        </Menu>
